...
variable "organisations_table_name" {
  default = "organisations"
}
variable "locations_table_name" {
  default = "locations"
}
variable "healthcare_services_table_name" {
  default = "healthcare_services"
}
variable "sdc_table_name" {
  default = "sdc"
}
variable "hash_key" {
  default = "id"
