...
When(
  "I enter {string} as the organisation name",
...
When(
  "I enter {string} as the organisation postcode",
...
Then(
  "I enter {string} as the managing organisation",
  async function (org: string) {
    await organisationsPage.inputOrg(org);
  },
);

When(
  "{string} is input as the organisation name",
  async function (name: string) {
    await organisationsPage.inputName(name);
  },
);
...
When(
  "{string} is input as the organisation postcode",
  async function (postcode: string) {
    await organisationsPage.inputPostcode(postcode);
  },
);
...
When(
  "{string} is input as the managing organisation",
  async function (org: string) {
    await organisationsPage.inputOrg(org);
  },
);
...
Then(
  "The instructions stating {string} are displayed on the page",
...
Then(
  "a postcode error message {string} is displayed on the page",
  async function (text: string) {
...
Then(
  "a name message {string} is displayed on the page",
  async function (text: string) {
...
Then(
  "a managing organisation error message {string} is displayed on the page",
  async function (text: string) {
...
Then(
  "a managing organisation error is not displayed on the page",
  async function () {
